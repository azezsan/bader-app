...
<Resizable.PaneGroup direction="horizontal" {onLayoutChange} class="max-h-screen items-stretch">
	<Resizable.Pane defaultSize={1 / 3} minSize={30} class="max-h-screen">
		<Tabs.Root value="all">
			...
			<div class="bg-background/95 p-4 backdrop-blur supports-[backdrop-filter]:bg-background/60">
				<form>
					<div class="relative">
						<Search class="absolute start-2 top-2.5 h-4 w-4 text-muted-foreground" />
	...
	<Resizable.Handle />
	<Resizable.Pane defaultSize={2 / 3} class="max-h-screen">
